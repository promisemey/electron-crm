export default {
  login: {
    name: 'Yun Audio-visual',
    system: 'CRM SYSTEM',
    versions: '© CRM SYSTEM 1.0.0',
    systemName: 'CRM SYSTEM',
    slogan: 'Make business online more efficient and accelerate enterprise digital upgrading.',
    ...
    cptPlaceholder: 'Please verification code',
    PWError: 'Please input a password',
    admin: 'Administrator',
    user: 'User',
    mobilePlaceholder: 'Please input Mobile',
    mobileError: 'Please input mobile',
    mobileCorrectError: 'Please enter the correct mobile number',
